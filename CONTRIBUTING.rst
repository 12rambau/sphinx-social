...
Thank you for your help improving **sphinx-social**!

**sphinx-social** uses `nox <https://nox.thea.codes/en/stable/>`__ to automate several development-related tasks.
...
First off, you'll need your own copy of **sphinx-social** codebase. You can clone it for local development like so:
...
.. code-block:: console
   ...
   git clone https://github.com/<YOUR USERNAME>/sphinx-social
   cd sphinx-social
...
This will install the **sphinx-social** library, together with two additional tools:
